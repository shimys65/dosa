...
<c:set var="pageTitle" value="PAGE TITLE : 회원정보수정" />
  ...
  function MemberModify__submit(form) {
    ...
    if (form.loginPw.value.length > 0) {
      ...
      if (form.loginPwConfirm.value.length == 0) {
        alert('비밀번호확인을 입력해주세요-modify.jsp.')
      ...
      if (form.loginPw.value != form.loginPwConfirm.value) {
        alert('비밀번호확인이 일치하지 않습니다-modify.jsp.');
        form.loginPwConfirm.focus();
    ...
    if (form.cellphoneNo.value.length == 0) {
      alert('휴대전화번호를 입력해주세요-modify.jsp.')
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <th>새 로그인비밀번호</th>
            <td>
              <input type="password" class="input input-bordered" name="loginPw" 
          ...
          <tr>
            <th>새 로그인비밀번호 확인</th>
            <td>
              <input type="password" class="input input-bordered w-full max-w-xs" name="loginPwConfirm" 
          ...
          <tr>
            <th>별명</th>
            <td>
              <input type="text" class="input input-bordered" name="nickname" placeholder="별명을 입력해주세요."
          ...
          <tr>
            <th>휴대전화번호</th>
            <td>
              <input type="tel" class="input input-bordered" name="cellphoneNo" 
              placeholder="휴대전화번호를 입력해주세요." value="${rq.loginedMember.cellphoneNo}" />
            </td>
          </tr>
          <tr>
            <th>회원정보수정</th>
